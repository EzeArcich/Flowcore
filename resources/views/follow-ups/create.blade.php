<x-layouts::app title="Nuevo follow-up">
    ...
    >
        <div class="fc-page-header flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
                <p class="fc-kicker">Follow-up</p>
                <h1 class="fc-page-title">Nuevo follow-up</h1>
            ...
            <a href="{{ route('follow-ups.index') }}" class="fc-btn fc-btn-secondary">Volver al listado</a>
        </div>
        ...
        <div class="fc-panel max-w-5xl">
            <form method="POST" action="{{ route('follow-ups.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    <div class="fc-card-soft space-y-4">
                        <div>
                            ...
                            <h2 class="fc-block-title">Empresa y contacto</h2>
                        </div>

                        <div>
                            <label for="company_search" class="fc-label">Empresa</label>
                            <input
                                id="company_search"
                        ...
                        <div x-show="selectedCompany" x-cloak class="fc-surface-soft space-y-2">
                            <p class="fc-kicker">Empresa seleccionada</p>
                        ...
                        <div>
                            <label for="contact_id" class="fc-label">Contacto</label>
                            <select
                                id="contact_id"
                                name="contact_id"
                                class="fc-select"
                    ...
                    <div class="fc-card-soft space-y-4">
                        <div>
                            <p class="fc-kicker">Recordatorio</p>
                            <h2 class="text-lg font-bold text-ink-900 dark:text-ink-50">Cuándo y por qué seguir</h2>
                        </div>

                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                <label for="due_date" class="fc-label">Fecha de vencimiento</label>
                                <input
                                    id="due_date"
                                    type="date"
                                    name="due_date"
                            ...
                            <div>
                                <label for="status" class="fc-label">Estado</label>
                                <select id="status" name="status" class="fc-select" required>
                        ...
                        <div>
                            <label for="reason" class="fc-label">Motivo</label>
                            <select id="reason" name="reason" class="fc-select">
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="4" class="fc-textarea">{{ old('notes') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    <div class="fc-card-soft space-y-4">
                        <div>
                            <p class="fc-kicker">Asociación opcional</p>
                            <h2 class="text-lg font-bold text-ink-900 dark:text-ink-50">Interacción</h2>
                        </div>

                        <div>
                            <label for="interaction_id" class="fc-label">Interacción vinculada</label>
                            <select
                                id="interaction_id"
                                name="interaction_id"
                                class="fc-select"
                    ...
                    <div class="fc-card-soft space-y-4">
                        ...
                        <div>
                            <label for="quotation_id" class="fc-label">Cotización vinculada</label>
                            <select
                                id="quotation_id"
                                name="quotation_id"
                                class="fc-select"
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    <a href="{{ route('follow-ups.index') }}" class="fc-btn fc-btn-secondary">Cancelar</a>
                    <button class="fc-btn fc-btn-primary">Guardar follow-up</button>
                </div>
            </form>
        </div>
    </div>
