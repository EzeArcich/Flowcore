        ...
        <div class="crm-card max-w-3xl p-6 space-y-6">
            ...
            <form method="POST" action="{{ route('companies.quotations.store', $company) }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" class="crm-input" required>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.01" name="amount" value="{{ old('amount') }}" class="crm-input" required>
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Moneda</label>
                        <input type="text" name="currency" value="{{ old('currency', 'USD') }}" class="crm-input" required>
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Horas estimadas</label>
                        <input type="number" name="estimated_hours" value="{{ old('estimated_hours') }}" class="crm-input">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="sent_at" value="{{ old('sent_at') }}" class="crm-input">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Válida hasta</label>
                        <input type="date" name="valid_until" value="{{ old('valid_until') }}" class="crm-input">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="scope_summary" rows="3" class="crm-textarea">{{ old('scope_summary') }}</textarea>
                </div>
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    ...
                    <button class="crm-btn-primary">Guardar cotización</button>
                </div>
            </form>
        </div>
    </div>
